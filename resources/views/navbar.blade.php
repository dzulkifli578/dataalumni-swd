<header>
    <nav class="navbar bg-base-100 py-0 mb-0 border-b border-base-content">
        <div class="container mx-auto flex justify-between items-center px-4">
            <!-- Navbar Start (Brand) -->
            <div class="navbar-start flex flex-row items-center">
                <a href="{{ route('index') }}" class="flex items-center">
                    <img src="{{ asset('img/swadhipa.png') }}" alt="Swadhipa" class="w-auto h-10 mr-4">
                    <span class="sm:text-lg md:text-xl lg:text-2xl font-semibold">
